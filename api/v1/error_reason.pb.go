...
const file_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x12error_reason.proto\x12\rhelloworld.v1*:\n" +
	"\vErrorReason\x12\x17\n" +
	"\x13GREETER_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01BI\n" +
	"\rhelloworld.v1P\x01Z$skyflow_backend/api/helloworld/v1;v1\xa2\x02\x0fAPIHelloworldV1b\x06proto3"
